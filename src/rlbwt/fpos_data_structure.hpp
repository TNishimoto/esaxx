...
namespace stool
{
    ...
    */
            static std::vector<uint64_t> construct_fpos_array(const sdsl::int_vector<> &bwt, const std::vector<uint64_t> &lpos_vec)
            {
            ...
            static void check(const sdsl::int_vector<> &bwt, const std::vector<uint64_t> &lpos_vec, const std::vector<uint64_t> &r)
            {
            ...
            static std::vector<uint64_t> construct(const sdsl::int_vector<> &bwt, const std::vector<uint64_t> &lpos_vec)
            {
